 ...
 *   <li>{@link gsn.impl.ContextImpl#isUninstantiated <em>Uninstantiated</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContextImpl extends ArgumentAssetImpl implements Context {
	...
	public void setUninstantiated(boolean newUninstantiated) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsn_Package.CONTEXT__UNINSTANTIATED, oldUninstantiated, uninstantiated));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Gsn_Package.CONTEXT__IS_PUBLIC:
				return isIsPublic();
			case Gsn_Package.CONTEXT__UNINSTANTIATED:
