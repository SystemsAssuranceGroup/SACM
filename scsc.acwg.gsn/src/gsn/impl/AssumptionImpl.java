 ...
 * </p>
 * <ul>
 *   <li>{@link gsn.impl.AssumptionImpl#isIsPublic <em>Is Public</em>}</li>
 *   <li>{@link gsn.impl.AssumptionImpl#isUninstantiated <em>Uninstantiated</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssumptionImpl extends ClaimImpl implements Assumption {
	...
	protected EClass eStaticClass() {
		return Gsn_Package.Literals.ASSUMPTION;
	}
	...
	public void setIsPublic(boolean newIsPublic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsn_Package.ASSUMPTION__IS_PUBLIC, oldIsPublic, isPublic));
	}
	...
	public void setUninstantiated(boolean newUninstantiated) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsn_Package.ASSUMPTION__UNINSTANTIATED, oldUninstantiated, uninstantiated));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Gsn_Package.ASSUMPTION__IS_PUBLIC:
				return isIsPublic();
			case Gsn_Package.ASSUMPTION__UNINSTANTIATED:
