 ...
 *   <li>{@link gsn.impl.SolutionImpl#isUninstantiated <em>Uninstantiated</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SolutionImpl extends ArtifactReferenceImpl implements Solution {
	...
	public void setUninstantiated(boolean newUninstantiated) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsn_Package.SOLUTION__UNINSTANTIATED, oldUninstantiated, uninstantiated));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Gsn_Package.SOLUTION__IS_PUBLIC:
				return isIsPublic();
			case Gsn_Package.SOLUTION__UNINSTANTIATED:
